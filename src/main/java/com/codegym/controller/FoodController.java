...
public class FoodController {
    ...
    @GetMapping("/{shop_id}/searchPrice")
    public ResponseEntity<List<Food>> searchFoodInShopByPrice(@RequestParam("priceMin") Double priceMin, @RequestParam("priceMax") Double priceMax) {
